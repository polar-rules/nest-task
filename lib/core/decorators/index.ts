...
/**
 * Namespace containing various modules related to the '_Decorators' functionality.
 *
 * @namespace
 */
export namespace _Decorators {
    /**
    ...
    /**
     * Namespace containing functionality related to the 'Constants' module.
     *
     * @namespace
     */
    ...
    /**
     * Namespace containing functionality related to the 'App' module.
     *
     * @namespace
     */
    export import App = $_App._App;
    /**
     * Namespace containing functionality related to the 'Arguments' module.
     *
     * @namespace
     */
    ...
    /**
     * Namespace containing functionality related to the 'Property' module.
     *
     * @namespace
     */
    ...
    /**
     * Namespace containing functionality related to the 'Task' module.
     *
     * @namespace
     */
    export import Task = $_Task._Task;
    /**
     * Namespace containing functionality related to the 'Validators' module.
     *
     * @namespace
     */
