...
describe("Core::ProjectConfiguration::Index", (): void => {
    const Subject = Core.ProjectConfiguration.Index;
    ...
    describe("#path", (): void => {
        it("Should correctly resolve path", (): void => {
            ...
            expect(
                subject.path.endsWith(path.join(Configs.Constants.Folders.tmp, entryPoint, "index.ts")),
            ).toBeTruthy();
        });
