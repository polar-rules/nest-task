...
describe("Bin::Dev::Generate::Jest::Config::Runner", (): void => {
    ...
    const Subject = Bin.Dev.Generate.Jest.Config.Runner;
    ...
    it("Should exit with error Main will throw error", async (): Promise<void> => {
        configureSpyOne = jest
            .spyOn(Cli.Dev.Generate.Jest.Config.Main.prototype, "configure")
            .mockImplementation(() => {
                throw new Error();
            });
        await Subject();
    ...
    it("Should exit successfully Main", async (): Promise<void> => {
        ...
        generateSpyOne = <any>(
            jest
                .spyOn(Cli.Dev.Generate.Jest.Config.Main.prototype, "generate")
                .mockImplementation(() => Promise.resolve())
        );
        finishSpyOne = jest.spyOn(Cli.Dev.Generate.Jest.Config.Main.prototype, "finish").mockImplementation(() => {});
