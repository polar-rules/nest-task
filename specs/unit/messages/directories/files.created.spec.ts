...
describe("Messages::Directories::Created", (): void => {
    const Subject = Messages.Directories.Created;
    ...
    it("Should have the correct message", (): void => {
        Subject([]);
        expect(console.info).toBeCalledWith("The following directories were created:");
    });
});
